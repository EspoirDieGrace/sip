...
import { AministrateurModalComponent } from './aministrateur-modal/aministrateur-modal.component';
...
export class AdministrateurComponent implements OnInit {
  ...
  openModal(mod, data?): void {
    ...
    if (mod === 'add') {
      ...
      msgBtn = 'Modifier';
      titre = 'Modifier un administrateur';
      callback = (d, obj) => this.update(d, obj);
    }
    const modal = this.modal.create({
      nzTitle: titre,
      nzWidth: 650,
      nzContent: AministrateurModalComponent,
    });
