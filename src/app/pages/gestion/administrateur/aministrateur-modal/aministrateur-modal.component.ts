...
@Component({
  selector: 'app-aministrateur-modal',
  templateUrl: './aministrateur-modal.component.html',
  styleUrls: ['./aministrateur-modal.component.scss']
})
export class AministrateurModalComponent implements OnInit {
  ...
  constructor(
    private myModal : NzModalRef<AministrateurModalComponent>,
